...
public class InventoryVersionWrapper1_8_R3 implements InventoryVersionWrapper {
    ...
    private class AnvilContainer extends ContainerAnvil {
        ...
        public void e() {
            ...
            IInventory g = ReflectionUtil.getFieldValue(this, "h", IInventory.class);
            IInventory h = ReflectionUtil.getFieldValue(this, "h", IInventory.class);
            EntityHuman m = ReflectionUtil.getFieldValue(this, "m", EntityHuman.class);
            String l2 = ReflectionUtil.getFieldValue(this, "l", String.class);
            ...
            if (itemstack == null) {
                ...
                ///this.k = 0;
                ReflectionUtil.changeFieldValue(this, "k", 0);
